    ...
    data: [
      {
        ...
        agentManager: 'system',
        agentUser: 'system',
        agentDescription: '专业的流量质量case排查助手，帮助您快速定位流量异常，分析用户行为模式',
        agentPrompt: '流量分析助手',
        createTime: Date.now(),
        status: 1
      },
      {
        ...
        agentManager: 'system',
        agentUser: 'system',
        agentDescription: '帮助您快速找到需要的数据表和指标，支持智能搜索和推荐',
        agentPrompt: '数据查询助手',
        createTime: Date.now(),
        status: 1
      },
      {
        ...
        agentManager: 'system',
        agentUser: 'system',
        agentDescription: '智能分析助手，提供专业的数据分析服务，帮助定位问题根源',
        agentPrompt: '分析助手',
        createTime: Date.now(),
        status: 1
      },
      {
        agentCode: 'policy_relation',
        agentName: '政策团组关系',
        agentCategory: '风险识别Agent',
        agentBelong: '风控团队',
        agentIcon: '',
        agentManager: 'system',
        agentUser: 'system',
        agentDescription: '智能识别团组关系和政策关联，支持工单号查询和执照关联分析',
        agentPrompt: '政策关系分析',
        createTime: Date.now(),
        status: 1
      },
      {
        ...
        agentManager: 'system',
        agentUser: 'system',
        agentDescription: '实时监测和识别可疑行为，提供多维度风险评分和预警',
        agentPrompt: '欺诈检测助手',
        createTime: Date.now(),
        status: 1
      },
      {
        agentCode: 'content_review',
        agentName: '内容审核',
        agentCategory: '通用助手',
        agentBelong: '内容团队',
        agentIcon: '',
        agentManager: 'system',
        agentUser: 'system',
        agentDescription: '智能内容审核助手，支持文本、图片、视频等多种内容格式的风险识别',
        agentPrompt: '内容审核助手',
        createTime: Date.now(),
        status: 1
      }
